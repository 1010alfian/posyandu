<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addDataAnakModal">Tambah Data Balita</button>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row">
                                        ...
                                        <?php foreach ($balita as $n) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a data-toggle="modal" data-target="#editDataAnakModal<?= $n['id_anak']; ?>" href="<?= base_url(); ?>anak/updateDataAnak/<?= $n['id_anak']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit">
        ...
        <div class="modal fade bs-example-modal-lg" id="editDataAnakModal<?= $row['id_anak']; ?>"" tabindex=" -1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Edit Form Data Balita</h4>
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 form-group">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="ibu_id">Nama Ibu</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="nama_ibu" value="<?= $row['nama_ibu'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
