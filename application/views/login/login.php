        ...
        <section class="login_content">
            <form class="user validate-form" action="<?php echo base_url('login'); ?>" method="POST">
                ...
                <div class="separator">
                    ...
                    <div>
                        <h1><img style="width: 29px; height: 29px; border-radius: 50%; margin-right: 10px" src="<?= base_url('build/img/'); ?>logo-posyandu-1.png" alt=""></i>Posyandu Kencana</h1>
                        <span>Copyright &copy; Posyandu Kencana <?= date('Y'); ?></span>
                    </div>
                </div>
            </form>
        </section>
