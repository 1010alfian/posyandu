                                        ...
                                        <tbody>
                                            <?php foreach ($d_anak as $d) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['nama_ibu']; ?></td>
                                                    <td>
                                                        <button id="pilihAnak_Laporan" type="button" data-id="<?= $d['id_anak']; ?>" data-nama="<?= $d['nama_anak']; ?>" data-tgllahir="<?= $d['tgl_lahir']; ?>"  data-ibu="<?= $d['nama_ibu']; ?>" class="btnSelectAnakLaporan btn btn-primary btn-sm">Pilih</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
