            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <form id="penimbangan-form" name="penimbangan-form" class="form-horizontal form-label-left" action="<?php echo base_url('penimbangan_anak/submit'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="lk">Lingkar Kepala [LK]
                            </label>
                            <div class="col-md-6 col-sm-6">
                                <input type=number step=any id="lk" name="lk" class="form-control">
                            </div>
                            <label class="col-form-label label-align" for="lk">cm
                            </label>
                        </div>
                        <div class="form-group row">
                                        ...
                                        <tbody>
                                            <?php foreach ($d_anak as $d) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['nama_ibu']; ?></td>
                                                    <td>
                                                        <button id="pilihAnak" type="button" data-id="<?= $d['id_anak']; ?>" data-nama="<?= $d['nama_anak']; ?>" data-tgllahir="<?= $d['tgl_lahir']; ?>" data-ibu="<?= $d['nama_ibu']; ?>" data-jk="<?= $d['jenis_kelamin']; ?>" class="btnSelectAnak btn btn-primary btn-sm">Pilih</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
